...
export class AppComponent {
  ...
  myth4 = ['Myth 4', 'Applying for a multi-currency wallet is difficult', 'Just download the YouTrip app, sign up, and receive the card in 7-10 days. The best part? It\'sFREE.', false, '/assets/img/main_4.jpg'];
